...
public class WoundedEffect : CustomEffect
{
	public static Color EffectColor = new Color(1f, 0.2f, 0.2f);

	public override string CustomEffectName => "LycansNewRoles.EffectWounded";

	public override string TranslateKey => "NALES_EFFECT_WOUNDED";
	...
	protected override void ApplyEffectToPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Wounded = NetworkBool.op_Implicit(true);
			}
		}
	}
	...
	protected override void RemoveEffectFromPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			if ((Object)(object)player != (Object)null)
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Wounded = NetworkBool.op_Implicit(false);
			}
		}
	}
}
