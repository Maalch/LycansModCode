...
public class SneakyEffect : CustomEffect
{
	public override string CustomEffectName => "LycansNewRoles.EffectSneaky";

	public override string TranslateKey => "NALES_EFFECT_SNEAKY";
	...
	protected override void ApplyEffectToPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Sneaky = NetworkBool.op_Implicit(true);
			}
		}
	}
	...
	protected override void RemoveEffectFromPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			if ((Object)(object)player != (Object)null)
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Sneaky = NetworkBool.op_Implicit(false);
			}
		}
	}
}
