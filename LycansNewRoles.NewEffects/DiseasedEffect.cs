...
public class DiseasedEffect : CustomEffect
{
	public static Color EffectColor = new Color(1f, 0f, 1f);

	public override string CustomEffectName => "LycansNewRoles.EffectDiseased";

	public override string TranslateKey => "NALES_EFFECT_DISEASED";
	...
	protected override void ApplyEffectToPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Disease = NetworkBool.op_Implicit(true);
			}
		}
	}
	...
	protected override void RemoveEffectFromPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			if ((Object)(object)player != (Object)null)
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Disease = NetworkBool.op_Implicit(false);
			}
		}
	}
}
