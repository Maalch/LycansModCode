...
public class KidnapperSilenceEffect : CustomEffect
{
	public override string CustomEffectName => "LycansNewRoles.EffectKidnapperSilence";

	public override string TranslateKey => "NALES_EFFECT_KIDNAPPER_SILENCE";
