...
public class SanctuaryEffect : CustomEffect
{
	public override string CustomEffectName => "LycansNewRoles.EffectSanctuary";

	public override string TranslateKey => "NALES_EFFECT_SANCTUARY";
	...
	protected override void ApplyEffectToPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Sanctuary = NetworkBool.op_Implicit(true);
			}
		}
	}
	...
	protected override void RemoveEffectFromPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			if ((Object)(object)player != (Object)null)
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Sanctuary = NetworkBool.op_Implicit(false);
			}
		}
	}
}
