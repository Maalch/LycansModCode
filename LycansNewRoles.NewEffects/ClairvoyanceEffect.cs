...
public class ClairvoyanceEffect : CustomEffect
{
	public override string CustomEffectName => "LycansNewRoles.EffectClairvoyance";

	public override string TranslateKey => "NALES_EFFECT_CLAIRVOYANCE";
	...
	protected override void ApplyEffectToPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Clairvoyance = NetworkBool.op_Implicit(true);
			}
		}
	}
	...
	protected override void RemoveEffectFromPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			if ((Object)(object)player != (Object)null)
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Clairvoyance = NetworkBool.op_Implicit(false);
			}
		}
	}
}
