...
public class PhasingEffect : CustomEffect
{
	public override string CustomEffectName => "LycansNewRoles.EffectPhasing";

	public override string TranslateKey => "NALES_EFFECT_PHASING";
	...
	protected override void ApplyEffectToPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Phasing = NetworkBool.op_Implicit(true);
			}
		}
	}
	...
	protected override void RemoveEffectFromPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			if ((Object)(object)player != (Object)null)
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Phasing = NetworkBool.op_Implicit(false);
			}
		}
	}
}
