...
public class StrenghtenedEffect : CustomEffect
{
	public override string CustomEffectName => "LycansNewRoles.EffectStrengthened";

	public override string TranslateKey => "NALES_EFFECT_STRENGTHENED";
	...
	protected override void ApplyEffectToPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			if ((Object)(object)player != (Object)null)
			{
				...
				player2.Strengthened = NetworkBool.op_Implicit(true);
			}
		}
	}
	...
	protected override void RemoveEffectFromPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			{
				PlayerCustom player2 = PlayerCustomRegistry.GetPlayer(targetPlayer);
				player2.Strengthened = NetworkBool.op_Implicit(false);
			}
		}
	}
}
