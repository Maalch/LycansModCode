...
public class TenacityEffect : CustomEffect
{
	public override string CustomEffectName => "LycansNewRoles.EffectTenacity";

	public override string TranslateKey => "NALES_EFFECT_TENACITY";
	...
	protected override void ApplyEffectToPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Tenacity = NetworkBool.op_Implicit(true);
			}
		}
	}
	...
	protected override void RemoveEffectFromPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			if ((Object)(object)player != (Object)null)
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Tenacity = NetworkBool.op_Implicit(false);
			}
		}
	}
}
