...
public class TournamentWinner : CustomEffect
{
	public override string CustomEffectName => "LycansNewRoles.EffectTournamentWinner";

	public override string TranslateKey => "NALES_EFFECT_TOURNAMENT_WINNER";
	...
	protected override void ApplyEffectToPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).TournamentWinner = NetworkBool.op_Implicit(true);
			}
		}
	}
	...
	protected override void RemoveEffectFromPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			if ((Object)(object)player != (Object)null)
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).TournamentWinner = NetworkBool.op_Implicit(false);
			}
		}
	}
}
