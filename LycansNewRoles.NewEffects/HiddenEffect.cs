...
public class HiddenEffect : CustomEffect
{
	public override string CustomEffectName => "LycansNewRoles.EffectHidden";

	public override string TranslateKey => "NALES_EFFECT_HIDDEN";
	...
	protected override void ApplyEffectToPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Hidden = NetworkBool.op_Implicit(true);
			}
		}
	}
	...
	protected override void RemoveEffectFromPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			if ((Object)(object)player != (Object)null)
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Hidden = NetworkBool.op_Implicit(false);
			}
		}
	}
}
