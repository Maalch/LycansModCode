...
public class RecuperatingEffect : CustomEffect
{
	public static Color EffectColor = new Color(0f, 1f, 0f);

	public override string CustomEffectName => "LycansNewRoles.EffectRecuperating";

	public override string TranslateKey => "NALES_EFFECT_RECUPERATING";
	...
	protected override void ApplyEffectToPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Recuperating = NetworkBool.op_Implicit(true);
			}
		}
	}
	...
	protected override void RemoveEffectFromPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			if ((Object)(object)player != (Object)null)
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Recuperating = NetworkBool.op_Implicit(false);
			}
		}
	}
}
