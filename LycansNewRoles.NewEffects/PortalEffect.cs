...
public class PortalEffect : CustomEffect
{
	public static Color EffectColor = new Color(1f, 0f, 0.5f);

	public override string CustomEffectName => "LycansNewRoles.EffectPortal";

	public override string TranslateKey => "NALES_EFFECT_PORTAL";
	...
	protected override void ApplyEffectToPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Portal = NetworkBool.op_Implicit(true);
			}
		}
	}
	...
	protected override void RemoveEffectFromPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			if ((Object)(object)player != (Object)null)
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Portal = NetworkBool.op_Implicit(false);
			}
		}
	}
}
