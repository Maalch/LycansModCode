...
public class PredatorEffect : CustomEffect
{
	public static Color EffectColor = new Color(1f, 0f, 0.5f);

	public override string CustomEffectName => "LycansNewRoles.EffectPredator";

	public override string TranslateKey => "NALES_EFFECT_PREDATOR";
	...
	protected override void ApplyEffectToPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Predator = NetworkBool.op_Implicit(true);
			}
		}
	}
	...
	protected override void RemoveEffectFromPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			if ((Object)(object)player != (Object)null)
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Predator = NetworkBool.op_Implicit(false);
			}
		}
	}
}
