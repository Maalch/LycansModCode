...
public class DisorientedEffect : CustomEffect
{
	public override string CustomEffectName => "LycansNewRoles.EffectDisoriented";

	public override string TranslateKey => "NALES_EFFECT_DISORIENTED";
	...
	protected override void ApplyEffectToPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Disoriented = NetworkBool.op_Implicit(true);
			}
		}
	}
	...
	protected override void RemoveEffectFromPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			if ((Object)(object)player != (Object)null)
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Disoriented = NetworkBool.op_Implicit(false);
			}
		}
	}
}
