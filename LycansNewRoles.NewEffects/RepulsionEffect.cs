...
public class RepulsionEffect : CustomEffect
{
	public override string CustomEffectName => "LycansNewRoles.EffectRepulsion";

	public override string TranslateKey => "NALES_EFFECT_REPULSION";
	...
	protected override void ApplyEffectToPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Repulsion = NetworkBool.op_Implicit(true);
			}
		}
	}
	...
	protected override void RemoveEffectFromPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			if ((Object)(object)player != (Object)null)
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Repulsion = NetworkBool.op_Implicit(false);
			}
		}
	}
}
