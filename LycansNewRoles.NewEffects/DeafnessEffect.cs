...
public class DeafnessEffect : CustomEffect
{
	public override string CustomEffectName => "LycansNewRoles.EffectDeafness";

	public override string TranslateKey => "NALES_EFFECT_DEAFNESS";
	...
	protected override void ApplyEffectToPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Deaf = NetworkBool.op_Implicit(true);
			}
		}
	}
	...
	protected override void RemoveEffectFromPlayerSpecific(PlayerRef targetPlayer)
	{
		...
		if (((SimulationBehaviour)this).HasStateAuthority)
		{
			...
			if ((Object)(object)player != (Object)null)
			{
				PlayerCustomRegistry.GetPlayer(targetPlayer).Deaf = NetworkBool.op_Implicit(false);
			}
		}
	}
}
